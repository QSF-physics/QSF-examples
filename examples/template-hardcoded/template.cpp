...
// using wf = Schrodinger::Spin0<BaseGrid<SingleOrMulti>, CoulombInteraction,
// DipoleCoupling<VelocityGauge, Fields...>>;
...
// F1 f1
// {
// 	SinPulse{{.field = 0.1, .omega = 0.06, .ncycles = 4.0, .FWHM_percent = 0.5, .phase_in_pi_units =
// 0, .delay_in_cycles = 0}}
// };
...
// F2 f2
// {
// 	GaussianEnvelope<SinPulse>{ {.field = 0.1, .omega = 0.06, .ncycles = 4.0, .FWHM_percent = 0.5,
// .phase_in_pi_units = 0, .delay_in_cycles = 0}}
// };
